...
<html>
    ...
    <body>
        ...
        <div class="panel-body">   
             ...
             <h3>panier reservé de : ${requestScope.adherent.nom} ${requestScope.adherent.prenom} </h3>
            <table class="table table-striped"> 
                ...
                <tbody>
                <form role="form" action="emprunter" method="post">
                <c:forEach var="resa" begin="0" items="${requestScope.listReservation}">   
                    <input type="hidden" id="adherentNom" name="adherentNom" value="${requestScope.adherent.nom}" >
                    <input type="hidden" id="adherentPrenom" name="adherentPrenom" value="${requestScope.adherent.prenom}" >
                    <input type="hidden" id="adherentDate" name="adherentDate" value="${requestScope.adherent.naissance}" >
                    <tr>
                        <td>${resa.oeuvre.id}&nbsp;&nbsp;</td> 
                        <td>${resa.oeuvre.titre}&nbsp;&nbsp;</td> 
                        <td>${resa.oeuvre.auteur}&nbsp;&nbsp;</td> 
                        <td>${resa.oeuvre.typeOeuvre}&nbsp;&nbsp;</td> 
                        <td>${requestScope.mapOeuvrDispo[resa.oeuvre.id]}&nbsp;&nbsp;</td>
                       
                        <td><input type="checkbox" name="check" value="${resa.oeuvre.id}" /></td>
                    </tr> 
                </c:forEach>
                </tbody>
            </table>
             <button type="submit" id="emprunter" value="emprunter" class="btn btn-default" style="float: right">Emprunter ces oeuvres</button>
            </form>
        </div>
        </div>
    </body>
